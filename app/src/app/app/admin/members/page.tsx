...
export default function AdminMembersPage() {
  ...
  return (
    <div className="flex min-h-full flex-col">
      <PageHeader eyebrow="Admin" title={tr("Membros e equipas", "Members and teams")} description={tr("Quem faz parte do negócio, com que papel, em que equipa e como as conversas são distribuídas.", "Who is part of the business, with which role, in which team, and how conversations are distributed.")} />
