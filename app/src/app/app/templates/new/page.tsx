...
import { ChevronLeft, Loader2, AlertCircle, ShieldCheck } from "lucide-react";
      ...
      <div className="grid gap-6 px-8 py-8 xl:grid-cols-[minmax(0,760px)_360px]">
        <form onSubmit={onSubmit} className="space-y-5">
          ...
          <button
            ...
            className="ml-2 inline-flex items-center gap-2 rounded-lg bg-[#0a152d] px-4 py-2.5 text-[13px] font-medium text-white transition-all hover:bg-[#0a1b33] disabled:opacity-50"
          >
