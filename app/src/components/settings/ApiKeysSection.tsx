      ...
      <div className="px-6 py-5 space-y-3">
        ...
        {keys === undefined ? (
          ...
          <div className="text-center py-6 border border-dashed border-line rounded-lg">
            <Key size={20} className="mx-auto text-faint mb-2" />
            <div className="text-[12px] text-muted">{tr("Ainda não existem chaves", "No keys yet")}</div>
          </div>
        ) : (
            ...
            {keys?.map((k) => (
              ...
              >
                <Key
                  size={14}
                  className={
                    k.revokedAt ? "text-faint" : "text-muted"
                  }
                />
                <div className="flex-1 min-w-0">
                  <div className="flex items-center gap-2">
                    <span
                      className={`text-[13px] font-medium ${k.revokedAt ? "text-faint line-through" : "text-ink"}`}
                    >
                      {k.name}
                    </span>
                  ...
                  <div className="text-[11px] text-muted mt-0.5 font-[var(--font-mono)]">
